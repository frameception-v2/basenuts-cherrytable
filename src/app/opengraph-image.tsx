...
export default async function Image() {
  return new ImageResponse(
    (
      <div tw="h-full w-full flex flex-col justify-center items-center relative bg-[#c00000]">
        <h1 tw="text-6xl text-center text-white mb-4">🍒 {PROJECT_TITLE}</h1>
        <h3 tw="text-3xl text-white text-center px-8">{PROJECT_DESCRIPTION}</h3>
      </div>
    ),
    {
      ...size,
